...
export default class TxGasUtil {
  ...
  */
  async analyzeGasUsage(txMeta) {
    ...
    const blockGasLimitBN = block.gasLimit;
    ...
    try {
      ...
      simulationFails = {
        ...
        debug: { blockNumber: block.number, blockGasLimit: bnToHex(block.gasLimit) },
      };
    }

    return { blockGasLimit: bnToHex(block.gasLimit), estimatedGasHex, simulationFails };
  }
  ...
  */
  async estimateTxGas(txMeta) {
    ...
    return bnToHex(await this.query.estimateGas(txParams));
  }
