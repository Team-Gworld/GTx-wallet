...
describe('migrations', function () {
  ...
  describe('Migrator', function () {
    it('migratedData version should be version 3', async function () {
      ...
      assert.equal(migratedData.meta.version, stubMigrations[2].version, `got ${migratedData.meta.version}`);
    });
    ...
    it('should match the last version in live migrations', async function () {
      ...
      assert.equal(migratedData.meta.version, liveMigrations[last]?.version || 0);
    });
